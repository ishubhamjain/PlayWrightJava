...
public class TestAssertionsECP {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            ...
            assertThat(page).hasURL("https://dp2iadqadt03-test.internal.iot.ocs.oraclecloud.com/ecp/ui/");
            assertThat(page).hasTitle("Enterprise Communication Platform");
            ...
            page.getByRole(AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Name")).fill("playwright2");
            ...
            assertThat(page.locator("//span[contains(.,'No Authentication')]/parent::label//*[contains(@class,'IconStyle_')]")).isVisible();
            assertThat(page.locator("//span[contains(.,'No Authentication')]/parent::label//*[contains(@class,'IconStyle_')]")).isChecked();
            assertThat(page.getByText("Enable MDM")).hasText("Enable MDM");
